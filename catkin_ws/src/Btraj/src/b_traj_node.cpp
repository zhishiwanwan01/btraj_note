...
╠══════════════════════════════════════════════════════════════════════════════════╣
║  1. 头文件包含                     │  4. 轨迹规划核心函数                        ║
║     1.1 标准C++库                  │     4.1 主规划函数 trajPlanning()          ║
║     1.2 第三方数学库               │     4.2 安全检查函数                        ║
║     1.3 PCL点云处理               │     4.3 碰撞检测函数                        ║
║     1.4 ROS核心组件               │                                            ║
║     1.5 ROS消息类型               │  5. 安全走廊生成                            ║
║     1.6 坐标变换系统               │     5.1 立方体生成函数                      ║
║     1.7 项目自定义头文件           │     5.2 立方体膨胀算法                      ║
║                                   │     5.3 走廊简化与优化                      ║
║  2. 全局变量定义                   │                                            ║
║     2.1 配置参数                   │  6. 时间分配与轨迹优化                      ║
║     2.2 系统状态变量               │     6.1 动力学时间分配                      ║
║     2.3 数据结构                   │     6.2 Bezier轨迹生成                     ║
║     2.4 ROS通信对象               │     6.3 轨迹消息封装                        ║
║     2.5 算法核心对象               │                                            ║
║                                   │  7. 可视化函数                              ║
║  3. ROS回调函数                    │     7.1 路径可视化                          ║
║     3.1 点云地图回调               │     7.2 走廊可视化                          ║
║     3.2 里程计回调                 │     7.3 轨迹可视化                          ║
║     3.3 目标点回调                 │                                            ║
║                                   │  8. 程序入口与初始化                        ║
║                                   │     8.1 main函数                           ║
